...
class TripsS2 extends Component{
    render(){
        return(    
            <Container fluid className="trips-s2 d-flex minh-50vh bg-white align-items-center py-5 border-top border-secondary">
